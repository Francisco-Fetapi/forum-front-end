...
export const Paper = styled(MuiPaper)`
    ...
    position:relative;
    opacity:.1;
    ${({irpara})=> irpara === 'baixo' && css`
        top:-150px;
    `}
    ${({irpara})=> irpara === 'cima' && css`
        top:150px;
    `}
...
export const Box = styled(MuiBox)`
    ...
    ${props => props.back_image && css`
        background-position:center;
        background-size:cover;
        /* background-image:url('./img/${props.back_image}') */
        background-image:url('${API.API_ROOT}/public/img/${props.back_image}')
    `}
`;
...
export const HomeHeader = styled(MuiBox)`
    ...
    background-image:url('${API.API_ROOT}/public/img/3.jpg');
...
export const PerfilHeader = styled(MuiBox)`
    ...
    background-image:url('${API.API_ROOT}/public/img/2.jpg');
    background-position:center;
    background-size:cover;
    height:300px;
    position:relative;
...
export const PerfilContent = styled(MuiBox)`
    ...
    background:url('${API.API_ROOT}/public/img/fundo1.svg') no-repeat;
    background-position:center;
    background-size:cover;
    background-attachment:fixed;
